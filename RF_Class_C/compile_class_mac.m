...
%%sometimes you have to add -lgfortran at the end of both command lines below
    mex src/mex_ClassificationRF_train.cpp  src/classRF.cpp src/classTree.cpp src/rfutils.cpp src/cokus.cpp rfsub.o -output mexClassRF_train -lm -DMATLAB -O
    mex src/mex_ClassificationRF_predict.cpp  src/classRF.cpp src/classTree.cpp src/rfutils.cpp src/cokus.cpp rfsub.o -output mexClassRF_predict -lm -DMATLAB -O
